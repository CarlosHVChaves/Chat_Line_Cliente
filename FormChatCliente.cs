...
{
    public partial class FormChatCliente : Form
    {
        ...
        private void btnConectarClick(object sender, System.EventArgs e)
        {
        ...
        private void InicializaConexao()
        {
            try
            {
                ...
                enderecoIP = IPAddress.Parse(txtServidor.Text);
        ...
        private void RecebeMensagens()
        {
            ...
            while (Conectado)
            {
                ...
                {
                    MessageBox.Show("Você se desconectou");
                }
            }
        }
        ...
        private void btnEnviarClick(object sender, System.EventArgs e)
        {
            EnviaMensagem();
        }
...
//String sql = "(SELECT NOME from Usuario WHERE LOGIN = 'TESTE' )";
...
//                // Envia o nome do usuário ao servidor
//                stwEnviador = new StreamWriter(tcpServidor.GetStream());
//stwEnviador.WriteLine(NomeUsuario.Length);
//                stwEnviador.Flush();
